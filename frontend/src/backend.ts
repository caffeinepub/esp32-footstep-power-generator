...
export class Backend implements backendInterface {
    ...
    async addEnergy(arg0: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addEnergy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addFootsteps(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFootsteps(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addRuntime(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRuntime(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalEnergy(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalEnergy();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalFootsteps(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalFootsteps();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalRuntime(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalRuntime();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
